...
int main(){
    ...
    ficheroSesgado_x_Avl = fopen("Datos/sesgado_x_Avl", "w");
    for (int i = 0; i < 100; i++){
    ...
    ficheroSesgado_sqrt_Avl = fopen("Datos/sesgado_sqrt_Avl", "w");
    for (int i = 0; i < 100; i++){
    ...
    ficheroSesgado_ln_Avl = fopen("Datos/sesgado_ln_Avl", "w");
    for (int i = 0; i < 100; i++){
